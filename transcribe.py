...
def download(url, resolution, videos_path):
    ...
    if file_name:
        ...
        yt = YouTube(url)
        yt.streams.filter(res=resolution, progressive=True).first().download(
...
if __name__ == "__main__":
    ...
    parser.add_argument("--url", type=str, required=False,
                        help="Single url method", default=None)
    parser.add_argument("--playlist", type=str, required=False,
                        help="Playlist url method", default=None)
    parser.add_argument("--res", type=int, required=False,
                        help="The resolution of the video(s) to download", default=1080)  # 360
    ...
    if args.url:
        ...
        videos_path = "../youtube_videos/"
        urls = os.listdir(videos_path)

        # urls = ["../youtube_videos/Aloha_En.mp4"]
    else:
